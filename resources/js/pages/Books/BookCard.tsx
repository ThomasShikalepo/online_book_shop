...
export default function BookCard({ book, className = "" }: { book: Book, className?: string }) {
    ...
    return (
        ...
        >
            ...
            <Link href={`/books/${book.id}`} className="shrink-0" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex flex-col justify-between py-1 flex-1 min-w-0 z-10 text-left">
                <div>
                    <Link href={`/books/${book.id}`} onClick={(e) => e.stopPropagation()}>
                ...
                <div className="mt-4">
                    ...
                    <button
                        ...
                        disabled={processing}
                        className="bg-amber-400 hover:bg-amber-500 disabled:opacity-70 transition-all text-black px-6 py-3 rounded-xl flex items-center justify-center gap-2 font-black shadow-lg shadow-amber-400/20"
                    >
